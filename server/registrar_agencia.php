...
if ($response['conexion']=='OK') {
	...
	$consulta = $con->ejecutarQuery("insert into agencias
	(nombre, numero_fiscal, segmento, iata, asociacion, consorcio, direccion, ciudad, pais, cp, nombre_personal, apellidos_personal, telefono_personal, email_personal, idioma_preferencial, observaciones) 
	values ('$nombre', '$numero_fiscal', '$segmento', '$iata', '$asociacion', '$consorcio', '$direccion','$ciudad','$pais','$cp','$nombre_personal','$apellidos_personal','$telefono_personal','$email_personal','$idioma_preferencial','$observaciones')");
