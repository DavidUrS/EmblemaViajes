<form>
	<div class="border border-secondary p-3">
	  <p class="display-4 text-center">Datos del cliente</p>
		...
		<div class="form-group row">
              <label class="col-md-4 col-form-label" for="servicios_contratar">Servicios a contratar / Solicitar información</label>
              <div class="col-md-8 text-center">
			...
			<div class="row">
				...
				<div class="col-md-4">
				    <input type="date" class="form-control" name="llegada"  placeholder="Fecha de llegada" required>
				</div>
				<div class="col-md-4">
			    	<input type="date" class="form-control" name="salida" placeholder="Fecha de salida" required>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
        ...
        <p>
          <strong><input type="checkbox" name="acepto"> He leído</strong>, 
		  acepto y estoy de acuerdo con las <strong class="text-primary">
		  <a target="_blank" href="javascript:window.open('./pdfs/politica_privacidad.pdf');">
		  Política de privacidad</a> </strong> y las <strong class="text-primary">
		  <a target="_blank" href="javascript:window.open('./pdfs/politica_cookies.pdf');">Política de cookies</a> </strong><br>
          Emblema Viajes permite a los clientes y a los alojamientos comunicarse a través 
		  de Emblema Viajes, que recibe y procesa estas comunicaciones de acuerdo con la 
		  Política de privacidad y el Acuerdo de colaboración de Emblema Viajes.
        </p>
