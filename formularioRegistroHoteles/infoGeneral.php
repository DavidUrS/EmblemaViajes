<form id="fomuGeneral">
        <div class="border border-secondary p-3">
          ...
          <div class="alert alert-primary text-center" role="alert">
            <h4>PASO 2 (Recuerda que si comenzaste a registrar los datos anteriormente y ya tus datos estan guardados, puedes usar la opcion, "CARGAR DATOS" y asi, no tendras que digitarlos nuevamente)</h4>
          </div>

          <div class="form-group row">
            <label class="col-md-4 col-form-label" for="cargo">Tipo de alojamiento</label>
            <div class="col-md-8 text-center">
              <select class="form-control" name="tipo_alojamiento" id="tipo_alojamiento">
                <option>Hotel</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="number" class="form-control" id="numero_habitaciones" placeholder="Ingrese numero de habitaciones" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control" id="barrio" placeholder="Ingrese barrio" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control" id="codigo_postal" placeholder="Ingrese código postal" required>
            </div>
          </div>

          <div class="row justify-content-around">
            <button class="btn btn-primary">Guardar y seguir</button>
            <button type="button" class="btn btn-outline-primary">Cargar datos ya registrados</button>
          </div>
