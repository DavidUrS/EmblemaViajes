<form id="formuCondicionesCancelacion">
	  ...
	  <div class="form-group row">
          <div class="col-md-6 text-center">
          	<div class="row align-self-center">
          		...
          		<div class="col-md-6">
          			<select class="form-control" id="cancelacion" name="cancelacion_grat">
        ...
        <div class="form-group row">
        	...
        	<div class="col-md-3 text-center">
        		<select class="form-control" id="fumar_propiedad" name="fumar_propiedad">
        	...
        	<div class="col-md-3 text-center">
        		<select class="form-control" id="aloj_ninos" name="aloj_ninos">
	              <option selected="selected">Si</option>
	              <option>No</option>
	            </select>
        	</div>
        ...
        <div class="form-group row">
        	...
        	<div class="col-md-3 text-center">
        		<select class="form-control" id="estancia_minima" name="estancia_minima">
