<form id="formuFiscal">
	<div class="border border-secondary p-3">
	  <p class="display-4 text-center">Datos fiscales</p>

	  	<div class="form-group row">
	      <label for="razon social" class="col-md-4 col-form-label">Razon social</label>
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="razon_social" placeholder="Ingrese razon social" required>
	      </div>
	    </div>

	    <div class="form-group row">
	      <label for="cedulaJuridica" class="col-md-4 col-form-label">RUT/NIF (Cédula Jurídica)</label>
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="rut" placeholder="Ingrese RUT/NIF" required>
	      </div>
	    </div>

	    <div class="form-group row">
	      <label for="rnt" class="col-md-4 col-form-label">RNT</label>
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="rnt" placeholder="Ingrese RNT" required>
	      </div>
	    </div>

	    <div class="form-group row">
	      <label for="categoriaIva" class="col-md-4 col-form-label">Categoria IVA</label>
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="categoria_iva" placeholder="Ingrese categoria IVA" required>
	      </div>
	    </div>
	    ...
	    <div class="form-group row">
	      ...
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="direccion_fiscal" placeholder="Ingrese direccion" required>
	      </div>
	    </div>
	    ...
	    <div class="form-group row">
	      ...
	      <div class="col-md-8">
	        <input type="text" class="form-control" id="ciudad_fiscal" placeholder="Ingrese ciudad" required>
	      </div>
	    </div>
			...
			<div class="form-group row">
					...
					<div class="col-md-8 text-center">
						<select class="form-control " name="pais_fiscal" id="pais">
