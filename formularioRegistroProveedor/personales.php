<form id="formuHoteles1">
          ...
          <div class="form-group row">
           ...
           <div class="form-group row">
              ...
              <div class="col-md-8 text-center">
                <select class="form-control " name="idioma_pref">
      ...
      <p>
        ...
        acepto y estoy de acuerdo con los <strong class="text-primary">
        <a target="_blank" href="javascript:window.open('./pdfs/term_y_cond.pdf');">
        Terminos y condiciones</a></strong> y la <strong class="text-primary">
        <a target="_blank" href="javascript:window.open('./pdfs/politica_privacidad.pdf');">
        Política de privacidad.</a> </strong><br>
        Emblema Viajes permite a los clientes y a los alojamientos comunicarse a través de Emblema 
        Viajes, que recibe y procesa estas comunicaciones de acuerdo con la Política de 
        privacidad y el Acuerdo de colaboración de Emblema Viajes.
      </p>
