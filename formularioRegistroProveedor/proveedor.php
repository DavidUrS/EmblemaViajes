<form>
	<div class="border border-secondary p-3">
	  <p class="display-4 text-center">Datos de proveedor</p>

	    <div class="form-group row">
	    	<label for="nombre agencia" class="col-md-4 col-form-label">Nombre de la empresa proveedora</label>
	      	<div class="col-md-8">
		    	<input type="text" class="form-control" id="nombre_prove" placeholder="Ingrese nombre" required>  
		    </div>
	  </div>
	    ...
	    <div class="form-group row">
          <label class="col-md-4 col-form-label" for="servicios">Servicios que ofrece el proveedor  </label>
          <div class="col-md-8 text-center">
            <select class="form-control " name="servicios">
              <option>Transfer aeropuerto</option>
              <option>Alquiler / Transporte terrestre con conductor</option>
              <option>Rent a car</option>
              <option>Alquiler / Transporte náutico </option>
              <option>Spa / Wellness / Masajes</option>
              <option>Pasadías / Daytour (islas, playas, campestre y todas las variedades)</option>
              <option>Alquiler bicicletas</option>
              <option>Alquiler Segway</option>
              <option>Guía ciudad / City guide</option>
              <option>Tickets / Entradas </option>
              <option>Catering / Servicios para eventos</option>
              <option>Servicios de traducción</option>
              <option>Alquiler vehículos blindados</option>
              <option>Transporte aéreo (no incluye líneas aéreas comerciales)</option>
              <option>Alquiler profesional de seguridad y guardaespaldas </option>
              <option>Personal shopper</option>
              <option>Alquiler servicios audio visuales </option>
              <option>Servicios asesoría jurídica </option>
              <option>Restaurante </option>
              <option>Servicios de Chef y/o cocinero/a</option>
              <option>Servicios de asistente personal</option>
              <option>Alquiler y servicios de vestuario </option>
              <option>Servicios de floristería </option>
              <option>Alquiler de ambientación para eventos, cumpleaños, etc.</option>
              <option>Wedding planner</option>
              <option>Alquiler vehículos alternativos (tipo buggy, cuatrimotos, etc.)</option>
              <option>Servicios de DJ y ambientación musical para eventos y fiestas</option>
              <option>Museo, Parques y similares</option>
              <option>Otros especificar en la casilla “Observaciones”</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group row">
		    ...
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="direccion_prove" placeholder="Ingrese direccion" required>
		    </div>
	    </div>
	    <div class="form-group row">
	    	<label for="nombre agencia" class="col-md-4 col-form-label">Ciudad</label>
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="ciudad_prove" placeholder="Ingrese ciudad" required>
		    </div>
	    </div>
