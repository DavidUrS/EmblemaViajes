...
<body>
  ...
  <p class="display-3 text-center">Registro de proveedor</p>

      <?php
        include_once './formularioRegistroProveedor/proveedor.php';
        include_once './formularioRegistroProveedor/personales.php';
      ?>
</div>
<?php
